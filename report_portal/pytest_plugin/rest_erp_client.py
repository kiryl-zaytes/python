...
class RP_API:
    ...
    HOST = 'https://rp.epam.com/reportportal-ws/api/v1'
    # HOST = 'https://rp.epam.com/reportportal-ws'
    USER = 'kiryl_zayets'
    PASSWORD = 'Random71099'
...
class ErpActions(object):
    ...
    def prepare_json(cls, command=RP_API.START_ROOT, http='POST', query_string=None, **kwargs):
        ...
        def send():
            try:
                response = http_action(url=req, data=data, auth=cls.auth, headers=RP_API.HEADER, verify=False)
